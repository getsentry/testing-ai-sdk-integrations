...
function scoreHelp(scoringVersion: AssessmentReport["scoringVersion"]): string {
	const explanation =
		scoringVersion === "3"
			? "Variant scores use fixed telemetry domains, so extra spans do not add points. 100 means no findings; info caps at 95, minor at 90, major at 75, critical at 59, and 0 means nothing ran."
			: "Scores are severity-weighted averages of evaluated telemetry observations.";
